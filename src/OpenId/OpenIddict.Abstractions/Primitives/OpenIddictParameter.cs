...
namespace OpenIddict.Abstractions
{
    ...
    public readonly struct OpenIddictParameter : IEquatable<OpenIddictParameter>
    {
        ...
        public OpenIddictParameter? GetNamedParameter(string name)
        {
            ...
            {
                throw new ArgumentException((SR.ID0192), nameof(name));
            }
        ...
        public OpenIddictParameter? GetUnnamedParameter(int index)
        {
            if (index < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(index), (SR.ID0193));
            }
        ...
        public override string? ToString() => Value switch
        {
            ...
            _ => throw new InvalidOperationException((SR.ID0194))
        };
        ...
        public void WriteTo(Utf8JsonWriter writer)
        {
            ...
            switch (Value)
            {
                ...
                default: throw new InvalidOperationException((SR.ID0194));
            }
        }
